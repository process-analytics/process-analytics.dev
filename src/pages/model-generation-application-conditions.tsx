    ...
    <Section>
      ...
      <Part flexDirection="column" width="80%" marginX="auto">
        ...
        <Paragraph fontSize={[1, 1, 2, 3]} marginTop={[4]} marginBottom={[4]}>
          ...
          responses available to third parties without permission, and we won’t
          use any contact details collected in the form except for sending the
          processing results.
          <br />
        </Paragraph>
      </Part>
      ...
      >
        ...
        <Paragraph fontSize={[1, 1, 2, 3]}>
          ...
          CONTENT IS COMPLETE, SUITABLE FOR YOUR PURPOSE, OR ACCURATE. THE
          PROCESS ANALYTICS PROJECT HEREBY EXPRESSLY DISCLAIMS ANY AND ALL
          ...
          PARTICULAR PURPOSE AND NON-INFRINGEMENT. THE ENTIRE RISK AS TO RESULTS
          OBTAINED THROUGH USE OF THE SITE AND/OR THE SITE CONTENT RESTS WITH
          YOU AND THE PROCESS ANALYTICS PROJECT MAKES NO REPRESENTATION OR
        ...
        <Paragraph fontSize={[1, 1, 2, 3]} marginTop={[4]}>
          ...
          COVER OR COST OF PROCUREMENT OF SUBSTITUTE GOODS OR SERVICES), EVEN IF
          THE PROCESS ANALYTICS PROJECT HAS BEEN ADVISED OF THE POSSIBILITY OF
          SUCH DAMAGES, AND REGARDLESS OF THE LEGAL THEORY UNDER WHICH DAMAGES
          ARE SOUGHT, WHETHER IN BREACH OF CONTRACT OR IN TORT, INCLUDING
          NEGLIGENCE.
        </Paragraph>
      </Part>
    </Section>
