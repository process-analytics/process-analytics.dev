...
export type HeaderRouteWithMenus = Required<Pick<LinkContent, 'name'>> & {
  /**
 ...
 */
export type HeaderRouteAsLink = Omit<LinkContent, 'description'>; // nav-link
